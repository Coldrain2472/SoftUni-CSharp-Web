        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Lecturer = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false, comment: "Seminar's lecturer"),
                    Details = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false, comment: "Seminar details"),
                    OrganizerId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Identifier of the organizer"),
                    DateAndTime = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Date"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SeminarId = table.Column<int>(type: "int", nullable: false, comment: "Identifier of the seminar"),
                    ParticipantId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Identifier of the participant")
                },
                constraints: table =>
                {
